...
public class UtilSBProjetos {
    ...
    private static void copiarArquivosNovoProjeto(Projeto p, boolean ignorarPresensaDePastaExistente) {
        ...
        File pastaSourceCliente = new File(p.getCaminhoPastaDoProjetoSourceLocal());
    ...
    public static void configurarPastaCliente(Cliente pCliente) {
        ...
        servidoresGitRelease.add("SERVIDOR_GIT_RELEASE=" + pCliente.getServicorGitRelease());

        List<String> servidoresGitSource = new ArrayList<>();
        servidoresGitSource.add("SERVIDOR_GIT_SOURCE=" + pCliente.getServidorGitCodigoFonte());

        String arquivoInfoClienteRelease = pastaClienteRelease + "/cliente.info";
        String arquivoInfoClienteSource = pastaClienteSource + "/cliente.info";
