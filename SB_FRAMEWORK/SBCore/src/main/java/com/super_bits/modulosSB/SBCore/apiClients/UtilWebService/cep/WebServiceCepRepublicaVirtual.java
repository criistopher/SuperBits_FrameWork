package com.super_bits.modulosSB.SBCore.apiClients.UtilWebService.cep;
 ...
 * {@link WebServiceCepRepublicaVirtual#searchCep(String)} para maiores
 * informa��es.
 * <BR>
 * <BR>Constroi um objeto {@link WebServiceCepRepublicaVirtual} com os dados XML
 * encapsulados, a partir da chamada do método estatico
 * {@link WebServiceCepRepublicaVirtual#searchCep(String)}.
 * <BR>
 * <BR>Objeto contem todas as informaçõees do XML, além de informações referente
 ...
 * <BR>
 * <BR>Exemplo de uso:
 * <BR><tt>{@link WebServiceCepRepublicaVirtual} cep =
 * {@link WebServiceCepRepublicaVirtual}.searchCep("13345-325");
 *
 ...
 */
public final class WebServiceCepRepublicaVirtual {
    ...
    private enum Xml {
         ...
         * {@link WebServiceCepRepublicaVirtual} no seu parametro
         * correspondente. Cada constante do enum conhece o seu parametro a
         * passar.
         *
         * @param text {@link String} contendo o texto a ser inserido.
         * @param webServiceCep {@link WebServiceCepRepublicaVirtual} referencia
         * do objeto para inserir o parametro text.
         */
        public abstract void setCep(String text, WebServiceCepRepublicaVirtual webServiceCep);
    }
     ...
     * objeto {@link WebServiceCepRepublicaVirtual}.
     * <BR>
     ...
     * caracters.
     * @return {@link WebServiceCepRepublicaVirtual} contendo as informa��es da
     * pesquisa.
     */
    public static WebServiceCepRepublicaVirtual searchCep(String cep) {
        cep = cep.replaceAll("\\D*", ""); //To numeric digits only
        if (cep.length() > 8) {
            cep = cep.substring(0, 8);
        }
        WebServiceCepRepublicaVirtual loadCep = new WebServiceCepRepublicaVirtual(cep);
        try {
            ...
            loadCep.setExceptio(ex);
            loadCep.setResultText("Erro na formalário da url.");
     ...
     * @param cep
     */
    private WebServiceCepRepublicaVirtual(String cep) {
        this.cep = cep;
    }
