    ...
    private void setClasseGenericaPorReflexao() {
        try {
            ...
            if (classe == null) {
                ...
                FabErro.SOLICITAR_REPARO.paraDesenvolvedor("Nao foi possivel obter o tipo da classe[" + this.getClass().getName() + " ]por reflexao, Especifique explicitamente o tipo da classe no constructor, ou utilize  new classe<tipo>{}", null);
