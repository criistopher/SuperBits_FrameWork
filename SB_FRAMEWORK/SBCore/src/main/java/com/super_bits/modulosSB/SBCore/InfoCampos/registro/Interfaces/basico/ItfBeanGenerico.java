 ...
 * 
 * O bean generico sbrescreve os metodos tostring, 
 * proporcionando a utilização do metodo equals de acordo com a regra de negócio 
 * dá poderes de validação e informações complementares para exibição do campo, 
 * seja em um projeto Web, desktop\JavaSwing, Mobile, e outros.
 * 
 * 
...
public interface ItfBeanGenerico {
    ...
    /**
     *
     * @param pNome nome do campo declarado, ou nome Da anotação do tipo InfoCampo que 
     * @return O Objeto campo instanciado, contendo get e set para obter os 
     * valores, Label, Tipo do campo, Validação e outras informaçoes importantes sobre o campo
     */
