 ...
 * {@link WebServiceCepRepublicaVirtual#searchCep(String)} para maiores informa��es.
 * <BR>
 * <BR>Constroi um objeto {@link WebServiceCepRepublicaVirtual} com os dados XML encapsulados, a
 * partir da chamada do método estatico {@link WebServiceCepRepublicaVirtual#searchCep(String)}.
 * <BR>
...
public final class WebServiceCepRepublicaVirtual {
    ...
    private enum Xml {
         ...
         * {@link WebServiceCepRepublicaVirtual} no seu parametro correspondente. Cada constante
         * do enum conhece o seu parametro a passar.
         *
         * @param text {@link String} contendo o texto a ser inserido.
         * @param webServiceCep {@link WebServiceCepRepublicaVirtual} referencia do objeto para
     ...
     * caracters.
     * @return {@link WebServiceCepRepublicaVirtual} contendo as informa��es da pesquisa.
     */
