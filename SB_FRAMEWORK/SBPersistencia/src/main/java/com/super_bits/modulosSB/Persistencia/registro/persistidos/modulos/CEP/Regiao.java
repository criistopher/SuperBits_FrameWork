...
public class Regiao extends EntidadeSimples implements ItfRegiao {
    ...
    @InfoCampo(tipo = FabCampos.LISTA_OBJETOS_OBJETOS, label = "Cidade", descricao = "Lista das cidades que compõem o estado selecionado")
    @ManyToMany
    private List<Cidade> cidades;

    @InfoCampo(tipo = FabCampos.LISTA_OBJETOS_OBJETOS, label = "Bairros", descricao = "Bairros de uma dada região")
    @ManyToMany
