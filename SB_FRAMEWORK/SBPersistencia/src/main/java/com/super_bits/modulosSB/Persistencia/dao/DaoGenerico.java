...
public class DaoGenerico<T extends ItfBeanSimples> extends ClasseTipada implements Serializable {
    ...
    public DaoGenerico() {
        ...
        FabErro.PARA_TUDO.paraSistema("Iniciou um Dao sem construtor", null);
    }
    ...
    public List<? extends T> achaItensPorSBNQ(SBNQ pSBQuery) {
        ...
        try {
            ...
            FabErro.SOLICITAR_REPARO.paraDesenvolvedor("erro em DaoGenerico.achaItens por SBNQ executando: query.getResultList ", e);
            return new ArrayList<>();
        }
    }
    ...
    public T achaItemPorSBNQ(SBNQ pQryInfo) {
        ...
        try {
            ...
            FabErro.SOLICITAR_REPARO.paraDesenvolvedor("erro Executando SBNQ", e);
            return null;
        }
    }
