...
public class CrudDataSet<T extends ItfBeanSimples> extends DaoGenerico<T> implements ItfCRUDDataSet<T> {
    ...
    public void proximo() {
        ...
        if (indexRegistroAtual > registros.size() - 1) {
            FabMensagens.enviarMensagemUsuario("Não existe um próximo registro", FabMensagens.AVISO);
    ...
    public void anterior() {
        ...
        if (indexRegistroAtual < 0) {
            FabMensagens.enviarMensagemUsuario("Não existe um registro anterior a este", FabMensagens.AVISO);
            indexRegistroAtual = 0;
        }
    ...
    public void salvar() {
        ...
        switch (estadoDataSet) {
            ...
            case ATUALIZANDO:
                ...
                break;
            case VISUALIZANDO:
                FabMensagens.enviarMensagemUsuario("A alteração de cadastro deste formulário está bloqueada, desbloqueie e tente novamente.", FabMensagens.AVISO);
                break;
        }
    ...
    public void novo() {
        ...
        try {
            ...
            FabErro.SOLICITAR_REPARO.paraDesenvolvedor("Erro gerando nova instancia de objeto em DaoGenerico", e);
            FabMensagens.enviarMensagemUsuario("Erro iniciando novo REgistro" + e.getMessage(), FabMensagens.ERRO);
        }
    }
