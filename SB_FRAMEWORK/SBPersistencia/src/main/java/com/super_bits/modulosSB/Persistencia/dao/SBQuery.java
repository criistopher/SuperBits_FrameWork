...
public abstract class SBQuery<T> {
        ...
        for (Field cp : camposReflexao) {
            ...
            if (i == pOrdem) {
                try {
                    ...
                    FabErro.SOLICITAR_REPARO.paraDesenvolvedor("erro ao tentar Injetar valor em Query" + this.getClass().getName(), e);
    ...
    private List<? extends T> executaQuery(String pSql) {
        ...
        while (respostaBanco.hasNext()) {
            ...
            try {
                ...
                FabErro.SOLICITAR_REPARO.paraDesenvolvedor("Classe do tipo SBQuery malformada" + this.getClass().getName(), e);
    ...
    private String makeSqlMinMedMax(String pTipo) {
        ...
        if (!temMinMedMaxNoSql()) {
            FabErro.SOLICITAR_REPARO.paraDesenvolvedor("Query não contem Minimo Maximo e Médio" + this.getClass().getSimpleName(), null);
