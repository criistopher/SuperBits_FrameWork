...
public abstract class EntidadeNormal extends EntidadeSimples implements ItfBeanNormal, ItfBeanPermisionado {
    ...
    public EntidadeNormal(Class<?> pClasseModelo) {
        ...
        adcionaCampoEsperado(new CampoEsperado(FabCampos.REG_ATIVO_INATIVO), true);
        adcionaCampoEsperado(new CampoEsperado(FabCampos.REG_DATAALTERACAO), true);
        adcionaCampoEsperado(new CampoEsperado(FabCampos.REG_DATAALTERACAO), true);
        adcionaCampoEsperado(new CampoEsperado(FabCampos.REG_USUARIO_ALTERACAO), true);
        adcionaCampoEsperado(new CampoEsperado(FabCampos.REG_USUARIO_INSERCAO), true);
