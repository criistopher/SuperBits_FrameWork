...
public class Tema {
    ...
    public void importarRollerTheme(FileUploadEvent event) {
        ...
        if (event.getFile() != null) {
            ...
            FabMensagens.enviarMensagemUsuario("Arquivo Importado com sucesso de" + event.getFile().getFileName(), FabMensagens.AVISO);

        } else {
            FabMensagens.enviarMensagemUsuario("Tentando aplicando template, certifique-se que baixou a versão jquery-ui-1.10.4", FabMensagens.AVISO);
        }
    }
