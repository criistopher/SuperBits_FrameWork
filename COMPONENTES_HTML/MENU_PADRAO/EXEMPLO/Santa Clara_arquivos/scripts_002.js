...
/* ------------------------------------------------------------------------ */ 	    
      jQuery('.home-slide-content').fitText(0.5);
	  jQuery('.fittext-content').fitText(0.5);
...
/* ------------------------------------------------------------------------ */ 
	...
	jQuery("nav.sticky-nav").sticky({ topSpacing: 60, className: 'sticky', wrapperClassName: 'main-menu-wrapper' });
