...
public class UtilSBShellScript {
    ...
    public static RespostaCMD executaComando(Comando pComando) {
        ...
        try {
            ...
            resposta.setRetornoPadrao(UtilSBCoreStrings.getStringByInputStream(p.getErrorStream()));
            resposta.setRetornoErro(UtilSBCoreStrings.getStringByInputStream(p.getInputStream()));
